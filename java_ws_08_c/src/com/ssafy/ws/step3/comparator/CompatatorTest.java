 ...
 * 
 * 
 * Comparator는 인터페이스로 반드시 구현되어야만 합니다. 비교는 항상 2개의 객체가 비교되어야합니다. Comparator는
 * Comparable과 다르게 2개의 객체를 compare 메소드를 통해 비교합니다.
 * 
 */
...
public class CompatatorTest {
	...
	public static void main(String[] args) {
		...
		// Q. 타입으로 List, 저장할 데이터 타입은 Person, 변수 이름으로 personList, 구현체로 ArrayList를 생성해
		// 봅시다.
		...
		for (Person p : personList) {
			System.out.println("이름: " + p.name + " / 키: " + p.height);
		}
